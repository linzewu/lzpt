...
<body>
	<form action="baseManager!saveBaseEntity.action" id="myform" name="myform" method="post" enctype="multipart/form-data">
		<div id="p" class="easyui-panel" style="padding: 10px; min-width: 700px; min-height: 300px;" title="投诉举报  案件详细">
				...
				<table style="width: 680px" border="0" class="base_table" cellpadding="0" cellspacing="0">
					<tbody>
						...
						<tr>
							...
							<td class="info"><span name="be.state" class="readField dataFormater"  dataKey="processState" ></span><input name="be.state" value="" type="hidden" /></td>
						</tr>
						...
						<tr>
							<td class="info_title">处理情况：</td>
							<td class="info" colspan="3">
								<div name="be.processInfo"  class="readField" style="word-break:break-all;width:500px;min-height: 30px"></div> 
								<input name="be.processInfo"  value=""  type="hidden" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="info" colspan="3">
							<div name="be.processResults"  class="readField"   style="word-break:break-all;width:500px; min-height: 30px"></div> 
							<input name="be.processResults"  value=""  type="hidden" /></td>
						</tr>
					</tbody>
				</table>
				<div align="center">
