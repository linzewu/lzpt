...
<body>
	<form action="cadreArchive!updateCadreArchive.action" id="myform" name="myform" method="post" enctype="multipart/form-data">
		<input name="cimStr" id="cimStr" style="display: none;" /> <input name="cwsStr" id="cwsStr" style="display: none;" /> <input
			name="weStr" id="weStr" style="display: none;" /> <input name="teStr" id="teStr" style="display: none;" /> <input name="rpStr"
			id="rpStr" style="display: none;" /> <input name="ca.id" value="${ca.id}" id="caId" style="display: none;" />
		<div id="tt" class="easyui-tabs">
			<div title="干部基础信息" style="padding: 5px;">
				<div style="margin-left: auto; margin-right: auto; vertical-align: middle; width: 780px; min-height: 400px;">
					...
					<div style="float: left;">
						<table style="width: 630px" border="0" class="base_table" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									<td class="info_title">姓名：</td>
									<td class="info"><input name="ca.cname" required="true" value="${ca.cname} " class="easyui-validatebox single_input" /></td>
								...
								<tr>
									...
									<td class="info"><input name="ca.nation" class="single_input" value="${ca.nation}" /></td>
									<td class="info_title">出生年月：</td>
									<td class="info"><input class="easyui-datebox single_input" name="ca.cbirthday"
										value="<fmt:formatDate value="${ca.cbirthday}" pattern="yyyy-MM-dd"/>" /></td>

								</tr>
								<tr>
									<td class="info_title">政治面貌：</td>
									<td class="info"><input name="ca.politicalStatus" class="single_input" value="${ca.politicalStatus }"></td>
									<td class="info_title">参加工作时间：</td>
									<td class="info"><input name="ca.worktime" class="easyui-datebox single_input"
										value="<fmt:formatDate value="${ca.worktime}" pattern="yyyy-MM-dd"/>" /></td>
								</tr>
								<tr>
									<td class="info_title">身份证：</td>
									<td class="info"><input name="ca.idCard" class="single_input" value="${ca.idCard}" /></td>
									<td class="info_title">入党时间：</td>
									<td class="info"><input name="ca.joinparty" class="easyui-datebox single_input"
										value="<fmt:formatDate value="${ca.joinparty }" pattern="yyyy-MM-dd"/>" /></td>
								</tr>
								<tr>
									<td class="info_title">学历：</td>
									<td class="info"><input name="ca.education" class="single_input" value="${ca.education }" /></td>
									<td class="info_title">职称：</td>
									<td class="info"><input name="ca.major" class="single_input" value="${ca.major }" /></td>

								</tr>
								<tr>
									<td class="info_title">电话：</td>
									<td class="info"><input name="ca.phone" class="single_input" value="${ca.phone }" /></td>
									<td class="info_title">在职情况：</td>
									<td class="info"><input name="ca.workState" type="radio" value="0" ${ca.workState== '0'? "checked='checked'":""} />在职<br /> <input
										name="ca.workState" type="radio" value="1" ${ca.workState== '1'? "checked='checked'":""} />已退出现职尚未办理退休手续</td>
								</tr>
								<tr>
									...
									<td class="info"><input name="ca.job" class="single_input" value="${ca.job}" /></td>
								</tr>
								<tr>
									<td class="info_title">婚姻状况：</td>
									<td class="info" colspan="3"><input name="ca.marriageState" type="radio" value="0"
										${ca.marriageState=='0'? "checked='checked'":""} />未婚 <input name="ca.marriageState" type="radio" value="1"
										${ca.marriageState=='1'? "checked='checked'":""} />已婚 <input name="ca.marriageState" type="radio" value="2"
										${ca.marriageState=='2'? "checked='checked'":""} />离异 <input name="ca.marriageState" type="radio" value="3"
										${ca.marriageState=='3'? "checked='checked'":""} />丧偶</td>
								</tr>
								<tr>
									<td class="info_title">户籍地：</td>
									<td class="info" colspan="3"><input name="ca.nativeplace" class="single_input_long" value="${ca.nativeplace }" /></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div align="center">
						<a href="javascript:saveBase()" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a> <a
			...
			<div title="述责述廉报告" style="padding: 5px;">
				<div style="margin-left: auto; margin-right: auto; vertical-align: middle; width: 750px; min-height: 400px;">
					...
					<div align="center">
						<a href="javaScript:saveWorkSummary()" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a>
					</div>
				</div>
			</div>
		</div>
