...
<form id="myform" name="myform"  method="post" novalidate action="workArchive!addWorkArchive.action">
...
<input name="wss" id="wsstr" style="display: none;"/>
	<div id="tt" class="easyui-tabs">
			...
			<table style="width: 100%;" border="0">
				<tbody>
					<tr>
						...
						<td><input class="easyui-validatebox" required="true" name="wa.wname" /></td>
						<td class="info_title">单位编码：</td>
						<td><input class="easyui-validatebox" name="wa.zipcode" /></td>
						<td class="info_title">负责人：</td>
						<td><input class="easyui-validatebox" name="wa.principal" /></td>
					</tr>
					<tr>
						<td class="info_title">联系电话：</td>
						<td><input class="easyui-validatebox" name="wa.phone" /></td>
						<td class="info_title">单位人数：</td>
						<td colspan="3"><input class="easyui-validatebox" name="wa.peoNum"  /></td>
					</tr>
					
					<tr>
						<td class="info_title">单位地址：</td>
						<td colspan="5"><input class="easyui-validatebox" name="wa.address" style="width: 490px;" /></td>
					</tr>
				</tbody>
			</table>
		...
		<div title="廉政工作总结" style="padding: 5px;">
			<div style="margin-top: 20px; margin-left: 50px; margin-bottom: 30px;">
				<input style="width: 500px" name="ws.years" id="wsyears"/>
			</div>
