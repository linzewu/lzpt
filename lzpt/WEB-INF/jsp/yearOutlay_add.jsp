...
<body type="add">
	<div class="easyui-panel" title="年度经费详细信息">
		<form method="post" action="yearOutlay!addYearOutlay.action" id="fm">
			<table title="添加年度经费" style="margin-left: 20px; margin-top: 10px;border-right: 1px solid #96B0C6; border-top: 1px solid #96B0C6; width: 80%" cellpadding="0" cellspacing="0" >
				<tr>
				    
					<th class="great_title"><label for="task.title">年份:</label></th>
					<td class="great_contex"><input class="easyui-validatebox" id="yoyear" 
						type="text" name="yo.yoyear" /></td>
				</tr>
				<tr>
					...
					<td class="great_contex"><input class="easyui-numberbox" data-options="min:0,precision:2" id="surplusMon" 
						type="text" name="yo.surplusMon" style="width: 124px;"/>
			...
			<input type="hidden" value="0" name="yo.state" id="state">
		</form>
	</div>
</body>
</html>