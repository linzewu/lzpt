...
<%
	...
	if(roleName.equals("纪委")||roleName.equals("纪委工作人员")){
		menuId="ycpp";
		defaultTitle="远程通告系统";
		defaultUrl="baseManager!NoticeAndCriticismList!toPage.action";
	}
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" 
		...
		<img alt="" src="${basePath }images/top5.jpg" style="margin: 0 auto; padding: 0; border: 0px; height: 112px;">
		<div class="nav">
			<ul>
				<% 
					if(roleName.equals("纪委")||roleName.equals("纪委工作人员")){ 
				%>
				<li><a href="javaScript:void(0);" onclick="showMenu('ycpp','baseManager!NoticeAndCriticismList!toPage.action')">远程通告系统</a></li>
				<li><a href="http://61.191.190.245:8082/geyi/login.aspx"  target="_blank">即时评价系统</a></li>
				<li><a href="http://10.177.10.88:8008/yxxjiancha"  target="_blank">电子监察系统</a></li>
	...
	<div data-options="region:'west',title:'功能菜单'" style="width: 230px;">
		...
		<div class="menus mpanel" id="ycpp" style="display: none;">
			<ul>
			<li><a href="javascript:void(0)" onclick="topage('baseManager!NoticeAndCriticismList!toPage.action',this)"><img
						alt="远程通知" src="${basePath}images/gif_47_029.gif" />通知及制度</a></li>
			<li><a href="javascript:void(0)" onclick="topage('baseManager!CriticismList!toPage.action',this)"><img
						alt="远程批评警告" src="${basePath}images/gif_47_030.gif" />批评警告</a></li>
			<li><a href="javascript:void(0)" onclick="topage('baseManager!CriticismReport!toPage.action',this)"><img
						alt="报表统计" src="${basePath}images/gif_47_032.gif" />报表统计</a></li>
			</ul>
		</div>
	</div>
