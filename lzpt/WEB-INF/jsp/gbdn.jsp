...
<%
	...
	if(roleName.equals("纪委")){
		menuId="dzda";
		defaultTitle="廉政电子档案";
		defaultUrl="workArchive!toPage.action?pageName=list&"+new Date().getTime();
	}
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" 
		...
		<img alt="" src="${basePath }images/top3.jpg" style="margin: 0 auto; padding: 0; border: 0px; height: 112px;">
		<div class="nav">
			<ul>
				<% 
					if(roleName.equals("纪委")){
