...
<div id="tt" class="easyui-tabs"  data-options="onSelect:tabOnSelect">
	<div title="评价明细"  style="padding:10px;">
		...
		<table id="EvaluationSupervision"   data-options="
					  ...
					  <thead>
					        <tr>
					        	<th data-options="field:'be.year',
																	                     width : 30,
																	                     formatter:yearFormatter">年度</th>
								<th data-options="field:'be.month',
																	                     width : 30,
																	                     formatter:monthFormatter">月份</th>
								<th data-options="field:'be.unit',
																	                     width : 80,
																	                     formatter:unitFormatter">单位</th>
								<th data-options="field:'be.score',width : 30">评价分数</th>	
								<th data-options="field:'be.evaluateExplain',width : 200,">评价说明</th>
