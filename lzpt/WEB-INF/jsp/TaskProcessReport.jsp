...
<div id="tt" class="easyui-tabs"  data-options="onSelect:tabOnSelect">
    <div title="乡镇廉政指数评估统计"  style="overflow:auto;padding:10px;">
    <input value="false"  type="hidden" name="isInit"  tableId="criticismReport">
      <table id="criticismReport"   data-options="url:'baseManager!!getBaseList.action?be.queryType=TaskProcessReportQuery',
			rownumbers:true,
			pagination:true,
			fitColumns:true,
			toolbar:'#toolbar2',
	    ...
	    <thead>
	        <tr>  
	           <th data-options="field:'year',width:10" >年份</th>
	            ...
	            <th data-options="field:'avgScore',width:10"   formatter="formaterNumber" >得分</th>
	        </tr>  
	      </thead>  
	</table>
