...
<body>
	<table id="dg" title="惩罚诉求列表" class="easyui-datagrid" data-options="onDblClickRow:toInfo,onSelect:initTool"
	    url="encourageAppeal!queryEncourageAppeal.action?ea.etype=1${roleName == '纪委'?'&ea.state=1':'' }"
	...
	<div id="toolbar" style="padding:5px;height:auto">
	    ...
	    %>
	    <div>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add"  plain="true" id="addtool"   onclick="toadd1()">添加</a>
        ...
        <a href="javascript:searchTB(${roleName == '纪委'?'1':'0' },1)" class="easyui-linkbutton" iconCls="icon-search">查找</a>  
    </div> 
	</div>
