...
<div class="easyui-tabs">
	...
	<div title="案例警示教育活动" style="padding: 10px 10px 10px 10px; height: 100%;width: 100%;" >
			<form id="pi90" method="post">
			<table class="base_table" cellpadding="0"  cellspacing="0">
				<tr>
					<td class="info_title"><label for="plan">案例警示教育:</label></td>
						        ...
						        <thead>
						            <tr>
						                <th data-options="field:'f1',width:100, editor:{type:'datebox',options:{ required:true}}" >时间</th>
						      	        <th data-options="field:'f2',width:100, editor:{type:'textbox',options:{ required:false}}">活动主持人</th>
						      	        <th data-options="field:'f3',width:100, editor:{type:'textbox',options:{ required:false}}">教育活动地点</th>
						      	        <th data-options="field:'f4',width:450, editor:{type:'textbox',options:{ required:false}}">警示教育报告(详情上传附件,填写附件名)</th>
						            </tr>
						        </thead>
						    </table>
			...
			<div align="center">
					<a href="javascript:void(0);" onclick="$('#pi90').submit()" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a>
			</div>
			...
			<input type="hidden" name="pi.piname" value="pi90">
		</form> 
...
var pconfig={
		"pi90":{"uploadfile":"uploadFile3","grid":"rwfg"}
	};
