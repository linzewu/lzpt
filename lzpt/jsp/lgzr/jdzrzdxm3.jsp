...
<div class="easyui-tabs">
	<div title="发现并查处违纪违规问题" style="padding: 10px 10px 10px 10px; height: 100%;width: 100%;" >
		<form id="pi58" method="post">
						        ...
						        <thead>
						            <tr>
						                <th data-options="field:'f1',width:100, editor:{type:'datebox',options:{ required:true}}" >时间</th>
						      	        <th data-options="field:'f2',width:100, editor:{type:'textbox',options:{ required:true}}">违纪违规人员</th>
						      	        <th data-options="field:'f3',width:100, editor:{type:'textbox',options:{ required:false}}">查处人员职务</th>
						      	        <th data-options="field:'f4',width:200, editor:{type:'textbox',options:{ required:false}}">指定授意暗示对象</th>
						      	        <th data-options="field:'f5',width:200, editor:{type:'textbox',options:{ required:false}}">地点</th>
						      	        <th data-options="field:'f6',width:400, editor:{type:'textbox',options:{ required:false}}">违纪违规问题描述（详情上传附件,填写附件名）</th>
						            </tr>
						        </thead>
						    </table>
			...
			<div align="center">
					<a href="javascript:void(0);" onclick="$('#pi58').submit()" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a>
			</div>
			...
			<input type="hidden" name="pi.piname" value="pi58">
		</form> 
	</div>
...
var pconfig={
		"pi58":{"uploadfile":"uploadFile","grid":"rwfg"}
	}; 
