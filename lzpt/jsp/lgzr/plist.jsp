...
<div style="width: 100%;height: 90%;">
	 <div id="proTab" class="easyui-tabs"  style="height:450px" >
	 <div title="项目列表" >
		<table id="projectList" class="easyui-datagrid"  data-options="onDblClickRow:pClickRow,url:'/lzpt/project!getProjects.action',border:true,singleSelect:true,fit:true,fitColumns:true,queryParams:{'pro.projectType':projectTypeId},footer:'#ft',toolbar:'#tb'">
			<thead>
				<tr>
					...
					<th data-options="field:'isCheck'" width="100">是否已被审阅</th>
				</tr>
			</thead>
		</table>
		</div>
 ...
 <div id="tb" style="padding:2px 5px;">
                            ...
                            单位: 
        <input id="unit" class="easyui-combobox" panelHeight="auto" style="width:100px" url="/lzpt/workArchive!queryWorkArchives.action" valueField="id" textField="wname" />
